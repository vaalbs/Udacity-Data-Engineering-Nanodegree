...
"""
    ...
    It extracts the log information in order to filter by NextSong, convert timestamp column to datetime.
    Then it extracts the user information in order to store it into the user table and songplay table.
...
"""
    Get all files matching extension from directory and total number of files found.
